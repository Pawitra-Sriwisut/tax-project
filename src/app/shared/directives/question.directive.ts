...
export class QuestionDirective implements OnInit, OnChanges {
    ...
    private generateRequiredHtml() {
        this.requiredHtml = this.el.nativeElement.innerHTML + `<svg style="margin-left: 5px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
